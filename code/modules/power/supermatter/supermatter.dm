...
/obj/machinery/power/supermatter_crystal/process_atmos()
	...
	merged_gasmix.change_moles(/datum/gas/plasma, max(device_energy * waste_multiplier / PLASMA_RELEASE_MODIFIER, 0))
	merged_gasmix.change_moles(/datum/gas/oxygen, max(((device_energy + merged_gasmix.temperature * waste_multiplier) - T0C) / OXYGEN_RELEASE_MODIFIER, 0))
